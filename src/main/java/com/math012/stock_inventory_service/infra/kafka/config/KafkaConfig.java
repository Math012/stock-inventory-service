package com.math012.stock_inventory_service.infra.kafka.config;
...
public class KafkaConfig {
    ...
    public NewTopic orderRequestingProductTopic(){
        return TopicBuilder.name(productHasStock)
                .partitions(1)
                .replicas(1)
                .build();
    }
    ...
    @Bean
    public NewTopic sendProductHasStockTopic(){
        return TopicBuilder.name(productOutOfStock)
                .partitions(1)
                .replicas(1)
                .build();
    }
